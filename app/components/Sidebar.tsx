...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    {
      name: text("liveCaptions", "Live Captions"),
      href: "/live-captions",
      icon: "CC",
    },
    {
      name: text("conversation", "Conversation"),
      href: "/conversation",
      icon: "💬",
    },
    {
      name: text("soundAlerts", "Sound Alerts"),
      href: "/sound-alerts",
      icon: "🔊",
    },
    {
      name: text("reminders", "Reminders"),
      href: "/reminders",
      icon: "🔔",
    },
  ];
    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-bottom">
        ...
        >
          ...
          <span>{text("profile", "Profile")}</span>
        </Link>
